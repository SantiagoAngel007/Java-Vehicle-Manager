...
public class CarPark{
	...
	public String showVehiclesByState(int stateTypeNum){
		...
		if(vehicles != null){
			for(int i=0; i< vehicles.size(); i++){
				if (vehicles.get(i) instanceof GasolineCar){
					if(((GasolineCar)vehicles.get(i)).getVehicleState() == true){
					news += ((GasolineCar)vehicles.get(i)).toString();
					news += "\n";
					//gasCar += " |Area : " + String.valueOf(figures[i].calculateArea());
					}
				}
		...
		if(vehicles != null){
			for(int i=0; i< vehicles.size(); i++){
				if (vehicles.get(i) instanceof ElectricCar){
					if(((ElectricCar)vehicles.get(i)).getVehicleState() == true){
					news += ((ElectricCar)vehicles.get(i)).toString();
					news += "\n";
					//gasCar += " |Area : " + String.valueOf(figures[i].calculateArea());
					}
				}
		...
		if(vehicles != null){
			for(int i=0; i< vehicles.size(); i++){
				if (vehicles.get(i) instanceof Hybrid){
					if(((Hybrid)vehicles.get(i)).getVehicleState() == true){
					news += ((Hybrid)vehicles.get(i)).toString();
					news += "\n";
					//gasCar += " |Area : " + String.valueOf(figures[i].calculateArea());
					}
				}
		...
		if(vehicles != null){
			for(int i=0; i< vehicles.size(); i++){
				if (vehicles.get(i) instanceof Motorcycle){
					if(((Motorcycle)vehicles.get(i)).getVehicleState() == true){
					news += ((Motorcycle)vehicles.get(i)).toString();
					news += "\n";
					//gasCar += " |Area : " + String.valueOf(figures[i].calculateArea());
					}
				}
		...
		if(vehicles != null){
			for(int i=0; i< vehicles.size(); i++){
				if (vehicles.get(i) instanceof GasolineCar){
					if(((GasolineCar)vehicles.get(i)).getVehicleState() == false){
					used += ((GasolineCar)vehicles.get(i)).toString();
					used += "\n";
					//gasCar += " |Area : " + String.valueOf(figures[i].calculateArea());
					}
				}
		...
		if(vehicles != null){
			for(int i=0; i< vehicles.size(); i++){
				if (vehicles.get(i) instanceof ElectricCar){
					if(((ElectricCar)vehicles.get(i)).getVehicleState() == false){
					used += ((ElectricCar)vehicles.get(i)).toString();
					used += "\n";
					//gasCar += " |Area : " + String.valueOf(figures[i].calculateArea());
					}
				}
		...
		if(vehicles != null){
			for(int i=0; i< vehicles.size(); i++){
				if (vehicles.get(i) instanceof Hybrid){
					if(((Hybrid)vehicles.get(i)).getVehicleState() == false){
					used += ((Hybrid)vehicles.get(i)).toString();
					used += "\n";
					//gasCar += " |Area : " + String.valueOf(figures[i].calculateArea());
					}
				}
		...
		if(vehicles != null){
			for(int i=0; i< vehicles.size(); i++){
				if (vehicles.get(i) instanceof Motorcycle){
					if(((Motorcycle)vehicles.get(i)).getVehicleState() == false){
					used += ((Motorcycle)vehicles.get(i)).toString();
					used += "\n";
					//gasCar += " |Area : " + String.valueOf(figures[i].calculateArea());
					}
				}
